  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        ...
        <li>
          <a href="#vertical-line-fix">Vertical line fix</a>
        </li>
      </ul>
    </li>
    <li>
...
|:----------:|:----------:|:----------:|:----------:|:----------:|
| 7805 IN | <10 V DC | 7.481 V | 7.223  V | PIN#1 7805(U12) |
| VCC | 5 V DC | 5.046 V | 4.987  V | PIN#3 7805(U12) |
...
<p align="center">
    <img src="Images/Cap_15.jpeg" alt="Description" width="800">
</p>
...
Below is a collection of pictures of the final result of the refurbishment of this Super Nintendo Entertainment System (SNES). Hope you like it! Click to enlarge!
