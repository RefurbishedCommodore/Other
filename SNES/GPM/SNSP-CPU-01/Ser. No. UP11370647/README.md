...
First, the ribbon cable for the control-port PCB is removed (1). Then the two screws holding the power switch are removed (2), and then finally the power switch cable is removed from the PCB (3). The top cover appears to be in good mechanical condition.
